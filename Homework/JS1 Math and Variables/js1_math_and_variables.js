...
function q5() {
  ...
  let jump1 = Number(prompt("Length of first jump: "));
  let jump2 = Number(prompt("Length of second jump: "));
  let jump3 = Number(prompt("Length of third jump: "));

  let average = (jump1 + jump2 + jump3) / 3;

  console.log(`Length of first jump: ${jump1}`)
  console.log(`Length of second jump: ${jump2}`)
  console.log(`Length of third jump: ${jump3}`)
  console.log(`The averag jump is ${average}`);
} //Average Jump
...
function q6() {
  ...
  console.log(`${celsius} Degree Celsius = ${fahrenheit.toFixed(2)} Fahrenheit`);
